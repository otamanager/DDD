		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					...
					<li <c:if test="${orders[0].orderType==1}">class="active"</c:if>><a href="getOrderByType?orderType=1">入库订单</a></li>
					<li <c:if test="${orders[0].orderType==2}">class="active"</c:if>><a href="getOrderByType?orderType=2">出库订单</a></li>
					<li <c:if test="${orders[0].orderType==3}">class="active"</c:if>><a href="getOrderByType?orderType=3">移仓单</a></li>
					<li <c:if test="${orders[0].orderType==4}">class="active"</c:if>><a href="getOrderByType?orderType=4">配送单</a></li>
				</ul>
				<ul class="nav nav-sidebar">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<h2 class="sub-header">
					<c:choose>
						<c:when test="${orders[0].orderType==1}">入库订单</c:when>
						<c:when test="${orders[0].orderType==2}">出库订单</c:when>
						<c:when test="${orders[0].orderType==3}">移仓单</c:when>
						<c:when test="${orders[0].orderType==4}">配送单</c:when>
					</c:choose>
				</h2>
