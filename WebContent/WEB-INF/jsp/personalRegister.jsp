	...
	<div class="container">
		<div class="row clearfix">
			<div class="col-md-12 column">
				<h1 style="color:#56abe4"><img alt="" src="image/logo_sm.png" style="width:40px;height:40px">&nbsp;&nbsp;个人用户注册&nbsp;&nbsp;<img alt="" src="image/step1.png" style="width:40px;height:40px">&nbsp;<img alt="" src="image/step2_1.png" style="width:40px;height:40px">&nbsp;<img alt="" src="image/step3_1.png" style="width:40px;height:40px"></h1><hr/>
			</div>
		</div>
		<div class="row clearfix">
			<!-- 图片 -->
			...
			<div class="col-md-4 column">
				<form role="form" action="personalRegister" method="post">
				...
				<div class="form-group">
					 <label for="name">姓名</label><input name="name" type="text" class="form-control" id="name" />
				</div>
				<div class="form-group">
