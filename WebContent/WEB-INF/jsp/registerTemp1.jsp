	...
	<div class="container">
			...
			<div class="col-md-12 column">
				<h1 style="color: #56abe4">
					<img alt="" src="image/logo_sm.png"
						...
						alt="" src="image/step3_1.png" style="width: 40px; height: 40px">
				</h1>
				<hr />
			</div>
		</div>
		<div class="row clearfix">
			...
			<div class="col-md-4 column" style="border-right: 2px solid #56abe4">
				<img style="width: 300px; hegit: 300px" alt="" src="image/email.png">
			</div>
			<div class="col-md-4 column">
				...
				<h3>
					请使用您的注册邮箱 <a
						href='http://mail.<c:out value="${emailType}"/>.com' target="_blank">激活</a>
					您的账户，开始享受我们的优质服务
				</h3>
			</div>
			<div class="col-md-2 column"></div>
