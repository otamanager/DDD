		...
		<div class="container">
			...
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li role="presentation"><a href="">现场入库单</a></li>
					<li role="presentation" class="active"><a href="displaySceneOrders">物资单队列</a></li>
		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				...
				<table class="table table-hover">
					<thead><tr><th>编号</th><th>订单号</th><th>创建人</th><th>创建日期</th><th>类型</th><th></th></tr></thead>
					<tbody>
						<c:forEach items="${sceneOrders }" var="order">
							...
							<td><c:if test="${order.sceneOrderType==1 }">现场入库单</c:if><c:if test="${order.sceneOrderType==2 }">现场出库单</c:if></td>
							<td><a href="displayScenerOrderDetails?code=<c:out value="${order.code }"/>" class="btn btn-info">详情</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
