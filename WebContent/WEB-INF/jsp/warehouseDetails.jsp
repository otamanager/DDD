			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="table-responsive">
					...
					<table class="table table-striped">
							...
							<tr><th>仓库编号</th>
							<td><c:out value="${warehouse.code }"></c:out></td></tr>
							<tr><th>仓储量</th>
							<td><c:out value="${warehouse.capacity }"></c:out></td></tr>
							<tr><th>经度</th>
							<td><c:out value="${warehouse.longitude }"></c:out></td></tr>
							<tr><th>纬度</th>
							<td><c:out value="${warehouse.latitude }"></c:out></td></tr>
							<tr><th>详细地址</th>
							<td><c:out value="${warehouse.location }"></c:out></td></tr>
					...
					<table class="table table-striped">
						...
						<tbody>
							<c:forEach items="${warehouse.warehouseEmployees }"
								var="employee">
								<tr>
									<td><c:out value="${employee.code }"></c:out></td>
									<td><c:out value="${employee.name }"></c:out></td>
									<td><c:out value="${employee.tel }"></c:out></td>
					...
					<table class="table table-striped">
						...
						<tbody>
							<c:forEach items="${warehouse.materials }" var="material">
								<tr>
									<td><c:out value="${material.code }"></c:out></td>
									<td><c:out value="${material.substance }"></c:out></td>
									<td><c:out value="${material.name }"></c:out></td>
									<td><c:out value="${material.owner }"></c:out></td>
									<td><a href="materialDetails?id=<c:out value="${material.id }"/>">物资详细</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
