					...
					<table class="table table-striped">
						...
						<tbody>
							<c:forEach items="${warehouses}" var="warehouse">
								<tr>
									<td><c:out value="${warehouse.code }"></c:out></td>
									<td><c:out value="${warehouse.capacity }"></c:out></td>
									<td><c:out value="${warehouse.longitude }"></c:out></td>
									<td><c:out value="${warehouse.latitude }"></c:out></td>
									<td><c:out value="${warehouse.location }"></c:out></td>
									<td><a href="warehouseDetails?id=<c:out value="${warehouse.id }"/>">仓储情况</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
